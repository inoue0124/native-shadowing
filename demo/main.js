...
var FileURL = 'wav/' + task_name + '/num_of_files';
var lateURL = 'late/late_' + task_name + '_' + q_num + '.txt';
var num_of_files;
var order_index;
var order_ary;
...
$(function(){
    ...
    $('#show-late-button').click(function(e) { showLate(e); return false; });
...
function initializeWaveforms() {
    ...
    wavesurfer_demo.load("./wav/" + task_name + "/" + task_name + "_" + q_num + ".wav");
...
function stopRecording() {
    ...
    recorder && recorder.exportWAV(function(blob) {
       ...
       wait (10).done(function () {
          $('#show-late-button').attr('disabled', false);
       });
       });
...
function submitButtonClicked(e) {
    ...
    if (q_num == num_of_files) {
     ...
     if (String(task_prog) == '10'){
       var URL = 'https://www.gavo.t.u-tokyo.ac.jp/~inoue0124/native-shadowing/demo/finish.php';
    ...
    if (task_prog != 11) {
    var URL = 'https://www.gavo.t.u-tokyo.ac.jp/~inoue0124/native-shadowing/demo/main.php?u=' + user_id + '&p=' + String(task_prog) + '&t=' + task_name + '&n=' + String(q_num);
    window.location.href = URL;
 }
}
