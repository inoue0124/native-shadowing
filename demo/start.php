<?php
 ...
 if (($_POST['pass'] == $pass) && ($pass != FALSE)) {
    ...
    header("Location: https://www.gavo.t.u-tokyo.ac.jp/~inoue0124/native-shadowing/demo/main.php?u=".$user_id."&p=". strval(intval($progress_id)+1) . "&t=".$first_task."&n=".strval(intval($last_slide)+1));
}else {
    echo "The password is invalid.  ";
?>
<a href="https://www.gavo.t.u-tokyo.ac.jp/~inoue0124/native-shadowing/demo/">Back</a>
<?php
}
?>
